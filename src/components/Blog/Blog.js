...
import logo from '../../images/sifat.jpeg'
import './Blog.css'
...
const Blog = () => {
    return (
      ...
      <div className='md:p-8 grid grid-cols-1 md:grid-cols-3 mt-20 gap-5 justify-center mt-7'>
      <div className='bg-blue-400 p-4 mt-5 shadow-blue-200 shadow-xl rounded-lg text-white'>
